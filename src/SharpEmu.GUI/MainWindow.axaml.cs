...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        EnvNativeDebuggerToggle.IsCheckedChanged += (_, _) =>
            SetEnvironmentToggle("SHARPEMU_NATIVE_DEBUGGER", EnvNativeDebuggerToggle.IsChecked == true);
    ...
    private void ApplyLocalization()
    {
        ...
        EnvNativeDebuggerDesc.Text = loc.Get("Options.Env.NativeDebugger.Desc");
    ...
    private void ApplySettingsToControls()
    {
        ...
        EnvNativeDebuggerToggle.IsChecked = _settings.EnvironmentToggles.Contains("SHARPEMU_NATIVE_DEBUGGER");
        UpdateLogFilePathText();
    }
